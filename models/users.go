...
type User struct {
	...
	ActivationCode         string    `boil:"activation_code" json:"activation_code" toml:"activation_code" yaml:"activation_code"`
	ActivationCodeValidity time.Time `boil:"activation_code_validity" json:"activation_code_validity" toml:"activation_code_validity" yaml:"activation_code_validity"`
...
var UserColumns = struct {
	...
	ActivationCodeValidity: "activation_code_validity",
	Deleted:                "deleted",
...
var (
	userColumns               = []string{"id", "uid", "username", "password", "activated", "activation_code", "activation_code_validity", "deleted", "created_at"}
	userColumnsWithoutDefault = []string{"uid", "username", "password", "activation_code", "activation_code_validity"}
	userColumnsWithDefault    = []string{"id", "activated", "deleted", "created_at"}
